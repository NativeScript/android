...
void Frontend::scriptParsed(const String16& scriptId, const String16& url, int startLine, int startColumn, int endLine, int endColumn, int executionContextId, const String16& hash, const Maybe<protocol::DictionaryValue>& executionContextAuxData, const Maybe<bool>& isLiveEdit, const Maybe<String16>& sourceMapURL, const Maybe<bool>& hasSourceURL)
{
...
void Frontend::scriptFailedToParse(const String16& scriptId, const String16& url, int startLine, int startColumn, int endLine, int endColumn, int executionContextId, const String16& hash, const Maybe<protocol::DictionaryValue>& executionContextAuxData, const Maybe<String16>& sourceMapURL, const Maybe<bool>& hasSourceURL)
{
    std::unique_ptr<protocol::DictionaryValue> jsonMessage = DictionaryValue::create();
