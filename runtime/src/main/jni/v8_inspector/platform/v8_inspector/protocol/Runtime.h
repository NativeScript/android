...
public:
    ...
    String16 getScriptId(const String16& defaultValue) { return m_scriptId.isJust() ? m_scriptId.fromJust() : defaultValue; }
    ...
    public:
        ...
        ExceptionDetailsBuilder<STATE>& setScriptId(const String16& value)
        {
...
public:
    ...
    void exceptionRevoked(const String16& reason, int exceptionId);
