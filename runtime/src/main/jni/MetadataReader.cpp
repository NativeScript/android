...
MetadataReader::MetadataReader()
        :
        m_nodesLength(0), m_nodeData(nullptr), m_nameLength(0), m_nameData(nullptr),
        m_valueLength(0), m_valueData(nullptr), m_root(nullptr),
...
string MetadataReader::ReadInterfaceImplementationTypeName(MetadataTreeNode *treeNode,
                                                           bool &isPrefix) {
