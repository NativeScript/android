...
require("./tests/nativeInheritanceTests/extendNativeClassInJS");
require("./tests/nativeInheritanceTests/extendNativeClassAndImplementInterfaceInJS");
require("./tests/nativeInheritanceTests/implementNativeInterfaceInJS");
