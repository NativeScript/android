...
shared.runMessageEventTests();
shared.runMessageChannelTests();
shared.runBroadcastChannelTests();
shared.runWorkerEventsTests();
shared.runNodeWorkerThreadsTests();
