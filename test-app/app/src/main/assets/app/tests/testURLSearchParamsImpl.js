describe("Test URLSearchParams ", function () {
    ...
    it("Test URL.searchParams returns the same object across reads", function(){
        const url = new URL("https://example.com/?a=1");
        expect(url.searchParams).toBe(url.searchParams);
    });

    it("Test URL.searchParams parses the query string on the first read", function(){
    ...
    it("Test URL.searchParams keeps the same object after assigning to search", function(){
        const url = new URL("https://example.com/?a=1");
        const sp = url.searchParams;
        url.search = "?x=1";
    ...
    it("Test URL.searchParams refreshes after assigning to search", function(){
        const url = new URL("https://example.com/?a=1");
        const sp = url.searchParams;
        expect(sp.get("a")).toBe("1");
    ...
    it("Test URL.searchParams refreshes after assigning to href", function(){
        const url = new URL("https://example.com/?a=1");
        const sp = url.searchParams;
        expect(sp.get("a")).toBe("1");
    ...
    it("Test URL.searchParams refreshes to empty when the query is cleared", function(){
    ...
    it("Test URL.searchParams preserves duplicate keys when refreshing", function(){
        const url = new URL("https://example.com/?a=1");
        const sp = url.searchParams;
    ...
    it("Test URL.searchParams writes mutations back to the url", function(){
        const url = new URL("https://example.com/?a=1");
        const sp = url.searchParams;
    ...
    it("Test URL.searchParams does not drop state on the read following a mutation", function(){
        const url = new URL("https://example.com/?a=1");
        const sp = url.searchParams;
    ...
    it("Test URL.searchParams interleaves mutations and direct assignments", function(){
        const url = new URL("https://example.com/?a=1");
        const sp = url.searchParams;
    ...
    it("Test URL.searchParams does not clobber a reassigned query when mutating a held reference", function(){
        const url = new URL("https://example.com/?a=1");
        const sp = url.searchParams;
    ...
    it("Test URL.searchParams does not expose its cache as an enumerable property", function(){
        const url = new URL("https://example.com/?a=1");
