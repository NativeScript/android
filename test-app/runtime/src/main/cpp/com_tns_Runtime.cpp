...
extern "C" JNIEXPORT void Java_com_tns_Runtime_TerminateRuntimeCallback(JNIEnv* env, jobject obj, jint runtimeId) {
...

    {
        ...
        // Worker isolates are owned natively (WorkerWrapper registry), so tear
        // down this runtime's child workers before destroying the isolate they
        // are parented to. Each child cascades to its own nested workers.
