...
//     walk (StartAsyncHttpModuleGraphLoad), which is how module bodies
//     normally arrive,
...
// cold-boot-only behaviors (JS-thread looper pump between synchronous
