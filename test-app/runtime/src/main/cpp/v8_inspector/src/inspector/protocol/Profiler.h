...
class  ConsoleProfileStartedNotification : public Serializable {
    ...
    public:
        ...
        bool hasTitle() {
            return m_title.isJust();
        }
        String getTitle(const String& defaultValue) {
            return m_title.isJust() ? m_title.fromJust() : defaultValue;
        }
...
class  ConsoleProfileFinishedNotification : public Serializable {
    ...
    public:
        ...
        protocol::Profiler::Profile* getProfile() {
            return m_profile.get();
        }
        void setProfile(std::unique_ptr<protocol::Profiler::Profile> value) {
