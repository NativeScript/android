...
class  AddHeapSnapshotChunkNotification : public Serializable {
    ...
    public:
        ...
        void setChunk(const String& value) {
            m_chunk = value;
        }
...
class  HeapStatsUpdateNotification : public Serializable {
    ...
    public:
        ...
        protocol::Array<int>* getStatsUpdate() {
            return m_statsUpdate.get();
        }
        void setStatsUpdate(std::unique_ptr<protocol::Array<int>> value) {
            m_statsUpdate = std::move(value);
        }
...
class  LastSeenObjectIdNotification : public Serializable {
    ...
    public:
        ...
        int getLastSeenObjectId() {
            return m_lastSeenObjectId;
        }
        void setLastSeenObjectId(int value) {
            m_lastSeenObjectId = value;
        }
...
class  ReportHeapSnapshotProgressNotification : public Serializable {
    ...
    public:
        ...
        bool hasFinished() {
            return m_finished.isJust();
        }
        bool getFinished(bool defaultValue) {
            return m_finished.isJust() ? m_finished.fromJust() : defaultValue;
        }
