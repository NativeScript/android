...
class  ConsoleMessage : public Serializable {
    ...
    public:
        ...
        bool hasLine() {
            return m_line.isJust();
        }
        int getLine(int defaultValue) {
            return m_line.isJust() ? m_line.fromJust() : defaultValue;
        }
        ...
        bool hasColumn() {
            return m_column.isJust();
        }
        int getColumn(int defaultValue) {
            return m_column.isJust() ? m_column.fromJust() : defaultValue;
        }
...
class  MessageAddedNotification : public Serializable {
    ...
    public:
        ...
        protocol::Console::ConsoleMessage* getMessage() {
            return m_message.get();
        }
        void setMessage(std::unique_ptr<protocol::Console::ConsoleMessage> value) {
