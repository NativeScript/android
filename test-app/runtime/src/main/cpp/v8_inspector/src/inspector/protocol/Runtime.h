...
class  StackTrace : public Serializable, public API::StackTrace {
    ...
    public:
        ...
        bool hasPromiseCreationFrame() {
            return m_promiseCreationFrame.isJust();
        }
        protocol::Runtime::CallFrame* getPromiseCreationFrame(protocol::Runtime::CallFrame* defaultValue) {
            return m_promiseCreationFrame.isJust() ? m_promiseCreationFrame.fromJust() : defaultValue;
        }
        void setPromiseCreationFrame(std::unique_ptr<protocol::Runtime::CallFrame> value) {
            m_promiseCreationFrame = std::move(value);
        }
