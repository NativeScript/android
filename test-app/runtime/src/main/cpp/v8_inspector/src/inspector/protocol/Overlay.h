...
class  HighlightConfig : public Serializable {
    ...
    public:
        ...
        protocol::DOM::RGBAColor* getEventTargetColor(protocol::DOM::RGBAColor* defaultValue) {
            return m_eventTargetColor.isJust() ? m_eventTargetColor.fromJust() : defaultValue;
        }
        void setEventTargetColor(std::unique_ptr<protocol::DOM::RGBAColor> value) {
        ...
        protocol::DOM::RGBAColor* getShapeColor(protocol::DOM::RGBAColor* defaultValue) {
            return m_shapeColor.isJust() ? m_shapeColor.fromJust() : defaultValue;
        }
        void setShapeColor(std::unique_ptr<protocol::DOM::RGBAColor> value) {
        ...
        protocol::DOM::RGBAColor* getShapeMarginColor(protocol::DOM::RGBAColor* defaultValue) {
            return m_shapeMarginColor.isJust() ? m_shapeMarginColor.fromJust() : defaultValue;
        }
        void setShapeMarginColor(std::unique_ptr<protocol::DOM::RGBAColor> value) {
        ...
        protocol::DOM::RGBAColor* getCssGridColor(protocol::DOM::RGBAColor* defaultValue) {
            return m_cssGridColor.isJust() ? m_cssGridColor.fromJust() : defaultValue;
        }
        void setCssGridColor(std::unique_ptr<protocol::DOM::RGBAColor> value) {
