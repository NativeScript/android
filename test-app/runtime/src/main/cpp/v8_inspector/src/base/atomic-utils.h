...
class AtomicValue {
    public:
        ...
        V8_INLINE void ClearBit(int bit) {
            SetBits(0, 1 << bit);
        }
...
class AtomicEnumSet {
    public:
        ...
        bool Contains(E element) const {
            return (ToIntegral() & Mask(element)) != 0;
        }
  ...
  do {                                                                    \
    ...
    do {                                                                  \
      old = base::Acquire_Load(&bits_);                                   \
        ...
        void Add(E element) {
            ATOMIC_SET_WRITE(|, Mask(element));
        }

        void Add(const AtomicEnumSet& set) {
