...
Local<Object> Module::CompileAndRun(const string& modulePath, bool& hasError)
{
	...
	else
	{
		...
		else
		{
			...
			Local<Value> requireArgs[7] { moduleObj, exportsObj, require, fileName, dirName, globalObj, globalObj };
...
const char* Module::MODULE_PART_1 = "(function(module, exports, require, __filename, __dirname, global, __global){ ";
