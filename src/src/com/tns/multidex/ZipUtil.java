...
final class ZipUtil
{
	...
	/*
	 * redefine those constant here because of bug 13721174 preventing to
	 * compile using the constants defined in ZipFile
	 */
	...
	/**
	 * Compute crc32 of the central directory of an apk. The central directory
	 * contains the crc32 of each entries in the zip so the computed result is
	 * considered valid for the whole zip file. Does not support zip64 nor
	 * multidisk but it should be OK for now since ZipFile does not either.
	 */
